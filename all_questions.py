...
def question2():
    ...
    # Infogain
    # below are entropies which is what is asked in the question in the pdf
...
def question3():
    ...
    answer["(f) explain choice"] = '''we choose Car type because it has the lowest gini index which implies that
    it has the maximal equality with the target among other attributes'''
...
def question5():
    ...
    explain["a"] = "Model 2"
    explain["a explain"] = '''as the model 2's training and test accuracies are more convergent than model 1's.
    model 1 semms to be overfitting the data.'''

    # string: one of 'Model 1' or 'Model 2'
    explain["b"] = "Model 2"
    explain["b explain"] = '''again model 2's errors semmes to be more convergent and model 1 is still overfitting
    the data as the training error is more than test error'''

    explain["c similarity"] = "minimize complexity."
    explain["c similarity explain"] = "Both models employ techniques to minimize model complexity by minimizing the amount of encoding needed to describe the model and data."
